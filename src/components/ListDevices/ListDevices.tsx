        ...
        <div key={product.key}>
          <Link
            ...
            <div className='list-devices'>
              <p className='list-device__photo'>
                {<img
                  src={`https://static.ui.com/fingerprint/ui/icons/${product.icon.id}_${product.icon.resolutions.sort()[4][0]}x${product.icon.resolutions.sort()[4][1]}.png`}
                  className="product_list_icon"
                  alt=""
                />}
              </p>
