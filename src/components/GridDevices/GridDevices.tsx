            ...
            <Link
              ...
              <div className='profileCard'>
                <figure className='grid-devices__figure'>
                  {<img
                    src={`https://static.ui.com/fingerprint/ui/icons/${product.icon.id}_${product.icon.resolutions.sort()[1][0]}x${product.icon.resolutions.sort()[1][1]}.png`}
                    className="grid-devices__photo"
                    alt=""
                  />}
                </figure>
